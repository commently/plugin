...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Commently"] = factory();
	else
		root["Commently"] = factory();
})(window, function() {
...
// extracted by mini-css-extract-plugin
module.exports = {"root":"App-root-3neFT","root_active":"App-root_active-1lf0B"};
...
// extracted by mini-css-extract-plugin
module.exports = {"root":"Pin-module-root-1iG2G","root_active":"Pin-module-root_active-3wO9I"};
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(5),r=__webpack_require__(10);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
var Pin_module = __webpack_require__(4);
...
function Pin(_ref) {
  ...
  return /*#__PURE__*/react_default.a.createElement("button", {
    className: classnames_default()(Pin_module["root"], (_classNames = {}, _classNames[Pin_module["root_active"]] = isActive, _classNames)),
    style: {
      left: clientX + "px",
      top: clientY + "px"
    },
...
function App_App() {
  ...
  function updatePins(recipe) {
    setPins(function (prevPins) {
      return immer_esm(prevPins, recipe);
    });
  }
  ...
  var handlePinClick = function handlePinClick(pinId) {
    return function () {
      updatePins(function (draftPins) {
        var closedPins = getClosedPins(draftPins);
  ...
  var handlePanelPost = function handlePanelPost(pinId) {
    return function (commentText) {
      updatePins(function (draftPins) {
        var _findPinById = findPinById(draftPins, pinId),
            comments = _findPinById.comments;
  ...
  var handlePanelCancel = function handlePanelCancel(pinId) {
    return function () {
      updatePins(function (draftPins) {
        var draftPin = findPinById(draftPins, pinId);
  ...
  return /*#__PURE__*/react_default.a.createElement("div", {
    ...
    }), isOpen && /*#__PURE__*/react_default.a.createElement(Panel_Panel, {
      clientX: clientX,
      clientY: clientY + 8,
      comments: comments,
